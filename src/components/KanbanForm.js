...
const KanbanForm = ({ submitHandler }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="form-inline">
            ...
            <label className="sr-only" htmlFor="inlineFormInputName2">Data Início</label>
            ...
            <label className="sr-only" htmlFor="inlineFormInputName2">Data Final</label>
            ...
            <label className="sr-only" htmlFor="inlineFormInputName2">Descrição</label>
